...
export const metadata: Metadata = {
  title: 'Privacy Policy | Appliance Tech Finder',
  description:
    'Privacy Policy for Appliance Tech Finder — how we collect, use, and protect your information.',
}
        ...
        <div className="rounded-lg bg-white p-8 shadow-sm sm:p-12">
          ...
          <div className="prose prose-gray mt-8 max-w-none">
            ...
            <p>
              ...
              <strong>MK153 Inc</strong> (&quot;MK153&quot;, &quot;we&quot;,
              &quot;us&quot;, or &quot;our&quot;) collects, uses, and protects
              personal information collected through the Appliance Tech Finder
              website and services (the &quot;Service&quot;). Appliance Tech
              Finder is a brand operated by MK153 Inc.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>Process business claims and submissions</li>
            ...
            <p>
              ...
              transactional emails and messages related to your use of the
              Service. Marketing communications may be sent in accordance with
              applicable laws and may be opted out of at any time.
            </p>
            ...
            <p>
              <strong>MK153 Inc</strong> is the data controller responsible for
            ...
            <p>
              ...
              correct, or delete your personal information. Requests may be
            ...
            <h2>10. Cookies</h2>
            <p>
              The Service may use cookies and similar technologies to improve
              functionality and user experience. You may disable cookies through
            ...
            <p>
              ...
              be posted with a revised effective date. Continued use of the
