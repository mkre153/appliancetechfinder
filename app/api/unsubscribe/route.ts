 ...
 * Token is HMAC-SHA256 of the email using NEWSLETTER_API_KEY as secret.
 *
...
export async function GET(request: Request) {
  ...
  return new NextResponse(
    htmlPage(
      ...
      "You will no longer receive newsletter emails from Appliance Tech Finder. We're sorry to see you go!"
    ),
...
<head>
  ...
  <title>${title} - Appliance Tech Finder</title>
  <style>
    body {
    ...
    a.btn:hover { background-color: #1e40af; }
  </style>
</head>
<body>
  <div class="card">
    <h1>${title}</h1>
    <p>${message}</p>
    <a class="btn" href="https://appliancetechfinder.com/">Back to Appliance Tech Finder</a>
  </div>
</body>
</html>`
}
